...
public class AdapterView_ListView_04_Activity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_adapterview_listview_04);

        AdapterView_ListView_04_Adapter adapter = new AdapterView_ListView_04_Adapter(
                this, R.layout.activity_adapterview_listview_04_row,
                getContactList());
