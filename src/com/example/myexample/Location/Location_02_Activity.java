...
public class Location_02_Activity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnStart:
                manager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 1000, 0, myListener);
                break;
            case R.id.btnStop:
    ...
    private class MyListener implements LocationListener {
        ...
        public void onProviderDisabled(String provider) {
            Toast.makeText(Location_02_Activity.this,
                    "위치서비스가 종료되었습니다.",Toast.LENGTH_LONG).show();

        }

        public void onProviderEnabled(String provider) {
            Toast.makeText(Location_02_Activity.this,
                    "위치서비스가 시작되었습니다.",Toast.LENGTH_LONG).show();
