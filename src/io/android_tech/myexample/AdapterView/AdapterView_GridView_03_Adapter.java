...
public class AdapterView_GridView_03_Adapter extends ArrayAdapter<AdapterView_GridView_03_Data> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.imageTitle = (TextView) row.findViewById(io.android_tech.myexample.R.id.text);
            holder.image = (ImageView) row.findViewById(io.android_tech.myexample.R.id.image);
            row.setTag(holder);
        } else {
