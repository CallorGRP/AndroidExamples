...
public class Network_02_Activity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.android_tech.myexample.R.layout.activity_network_02);
        url = (EditText) findViewById(io.android_tech.myexample.R.id.url);
        webpage = (TextView) findViewById(io.android_tech.myexample.R.id.webpage);
