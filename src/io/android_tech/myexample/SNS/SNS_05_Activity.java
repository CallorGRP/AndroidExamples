...
public class SNS_05_Activity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.android_tech.myexample.R.layout.activity_sns_05);

        loginManager = LoginManager.getInstance();
        callbackManager = CallbackManager.Factory.create();
        loginButton = (Button) findViewById(io.android_tech.myexample.R.id.login_button);
        btn_share1 = (Button) findViewById(io.android_tech.myexample.R.id.btn_share1);
        btn_share2 = (Button) findViewById(io.android_tech.myexample.R.id.btn_share2);
        btn_share3 = (Button) findViewById(io.android_tech.myexample.R.id.btn_share3);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case io.android_tech.myexample.R.id.login_button:
                loginManager.logInWithReadPermissions(this, Arrays.asList("email"));

                break;
            case io.android_tech.myexample.R.id.btn_share1:
                ...
                break;
            case io.android_tech.myexample.R.id.btn_share2:
                ...
                break;
            case io.android_tech.myexample.R.id.btn_share3:
                break;
        }
    }
