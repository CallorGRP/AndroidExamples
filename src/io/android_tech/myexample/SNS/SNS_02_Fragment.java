...
public class SNS_02_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(io.android_tech.myexample.R.layout.activity_sns_01, container, false);

        callbackManager = CallbackManager.Factory.create();
        LoginButton loginButton = (LoginButton) view.findViewById(io.android_tech.myexample.R.id.login_button);
