    ...
    private class MyListener implements LocationListener {
        public void onLocationChanged(Location location) {
            if (!isMoved) {
                ...
                map.addMarker(new MarkerOptions().position(gas_station).icon(BitmapDescriptorFactory.fromResource(io.android_tech.myexample.R.drawable.gas_station)).title("주유소").snippet("가장가까운 주유소입니다."));
